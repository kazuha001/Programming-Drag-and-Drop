    ...
    var hidden2Id = document.getElementById("hidden2")
    
    var ctx = myCanvasId.getContext("2d")
    
    //Change Hidden Value
    
    hidden2Id.value = "close"
   
   //For Img Location
   
   //dress
      var dress1 = new Image()
    dress1.src = "css/images/shade/shade2.png"
    dress1.width = 40
    dress1.height = 40
   ...
   myCanvasId.addEventListener("mousedown", function(event) {
    ...
    function addImg10() {
        ...
        var hidden2Id = document.getElementById("hidden2").value
