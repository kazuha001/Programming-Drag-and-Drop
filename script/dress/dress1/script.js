   ...
   //dress
    ...
    dress1.src = "css/images/dress/dress1.png"
    dress1.width = 400
    dress1.height = 400
   ...
   myCanvasId.addEventListener("mousedown", function(event) {
    ...
    function stopDragging() {
        ...
        var bt1Id = document.getElementById("bt1")

        var bt2Id = document.getElementById("bt2")

        bt1Id.style.display = "none"

        bt2Id.style.display = "block"

        isDraggingAllowed = false

        alert("Canvas has been Finilize")
